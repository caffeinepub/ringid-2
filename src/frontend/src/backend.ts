...
export class Backend implements backendInterface {
    ...
    async createRoom(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getLiveRooms(): Promise<Array<Room>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLiveRooms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMessagesByRoom(arg0: bigint): Promise<Array<ChatMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessagesByRoom(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalRooms(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalRooms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async joinRoom(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
